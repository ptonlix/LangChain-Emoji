...
from langchain_emoji.settings.settings_loader import load_active_settings
...
class TvectordbSettings(BaseModel):
    url: str
    username: str
    api_key: str
    collection_name: str
...
class DatasetSettings(BaseModel):
    name: str
    google_driver_id: str
    mode: Literal["minio", "local"]
